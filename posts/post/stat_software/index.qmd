...
::: {.column-margin}
ggplot2 really advocates for the creation of diagrams with multiple dimensions, of which 
an early example is the well-know Minard map as below

![Minard map](featured.png){#fig-minard}
:::
